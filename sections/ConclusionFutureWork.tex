...
In this paper, we present a novel sampling \QM{technique} $\avats$ which guarantees the visual fidelity at overview and reduce the visual clutter at the detail views.
