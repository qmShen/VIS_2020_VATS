...
In this paper, we present a novel sampling techniques $\avats$ which guarantees the visual fidelity at overview and reduce the visual clutter at the detail view. We evaluate the effectiveness of proposed method by applying our approach to different dataset and conducting users studies on specific trajectory exploration tasks.

There are several promising future directions. First we focus on the sampling approach of trajectory segments other than the whole trajectories to achieve higher visual fidelity. 
