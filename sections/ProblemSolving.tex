...
For each trajectory $\D_i in \D$ is a set of pixels at highes zoom level in the canvas.
...
We next elaborate an ``one-to-many'' strategy to further optimize the visual quality of our proposal.
