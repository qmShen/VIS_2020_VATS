...
%{Aggregating-based optimization techniques~\cite{zeng2013visualizing,von2015mobilitygraphs} in the middle-layer support interactive visual analysis for large-scale data by reducing the number of rendering data.}
...
For more details of other aggregating-based techniques, we refer the reader to the survey work\TB{~\cite{andrienko2008spatio}}.
...
Sampling techniques are well-studied in the interactive visualization problems with large-scale input data.
