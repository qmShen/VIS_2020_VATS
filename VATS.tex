...
(II) G, H, and I are visualizations of the whole \pt{} dataset, random sampling with sampling rate 0.01, and $\avats$ with sampling rate 0.01 at zoom level 15, respectively.
}
   }
	\label{fig:teaser}
}
