...
%   B and C are visualization results of uniform random sampling approach with sampling rate $0.1\%$ and $1\%$, respectively.
%   D, E, F are the visualization results of our advance visual fidelity guaranteed sampling approach $\avats$ with different parameters.
%   (II) G, H, and I are the visualization results of full \pt{} dataset, uniform random sampling $\rand$ result set, and our proposal $\avats$ result set at zoom level 15, respectively.
   Comparison of random sampling and $\avats$. (i) A is the visualization of the whole Porto taxi trajectory dataset at zoom level 11.
